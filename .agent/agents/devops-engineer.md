...
model: inherit
skills: clean-code, deployment-procedures, server-management, powershell-windows, bash-linux, docker-expert, github-workflow-automation, aws-serverless, gcp-cloud-run, azure-functions, vercel-deployment, neon-postgres, environment-setup-guide, linux-shell-scripting, trigger-dev
---

...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux, agent-evaluation, agent-memory-systems, dispatching-parallel-agents, subagent-driven-development, multi-agent-brainstorming, langgraph
---

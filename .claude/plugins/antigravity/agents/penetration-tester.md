...
model: inherit
skills: clean-code, vulnerability-scanner, red-team-tactics, api-patterns, pentest-checklist, pentest-commands, metasploit-framework, burp-suite-testing, sqlmap-database-pentesting, active-directory-attacks, aws-penetration-testing, cloud-penetration-testing, ethical-hacking-methodology, shodan-reconnaissance, network-101, wireshark-analysis, ssh-penetration-testing, smtp-penetration-testing, wordpress-penetration-testing, privilege-escalation-methods, linux-privilege-escalation, windows-privilege-escalation
---
